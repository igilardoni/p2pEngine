...
public class ObjetAdvertisement extends Advertisement{
	...
	private final static String nomAuteurTag = "nomAuteur";
	...
	private final static String[] fields = { idTag, fullNameTag, nameTag, nomAuteurTag };
	...
	protected boolean handleElement(TextElement elem) {
		...
		//on récupére l'id et on vérifie que celui-ci a un format correct
		 ...
		 if(elem.getName().equals(nomAuteurTag)) {
			 setNomAuteur(elem.getTextValue());
			 return true;
		 }
	...
	public Document getDocument(MimeMediaType asMimeType) {
        ...
        e = adv.createElement(nomAuteurTag, getNomAuteur());
        adv.appendChild(e);
