...
public class AjouterOffreWindow extends JFrame{
	...
	private void add() {
		Offre offre = new Offre(nom.getText(), description.getText(), enEchange.getText(), app.getUser());
		app.publishOffre(offre);
		this.dispose();
	}
	
	public AjouterOffreWindow(Application app) {
		this.app = app;
		...
		JLabel label =  new JLabel("Nom de l'objet à donner");
		panel.add(label);
		...
		label = new JLabel("Nom de l'objet voulu");
		panel.add(label);
